  ...
  <div class="MessageCipherMain">
    <el-row class="container">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <p>MessageCipher V2.1 Beta(Web)</p>
        </el-col>
  ...
  methods: {
    ...
    async generateCryptedMessageAesKey () {
      ...
      if (pass) {
        ...
        var serverPublicKeyEncryptedMessageAesKey = this.encryptByRsaPublicKey(this.serverRSAPubKey, this.requestData.messageAesKey)
        ...
        var dataPack = {
          ...
          messageAesKey: serverPublicKeyEncryptedMessageAesKey, // 用服务器私钥解密
      ...
      if (pass) {
        ...
        this.$axios.post('', dataPack).then((res) => {
          if (res.data.code === '200') {
            ...
            this.requestData.messageAesKey = this.decryptByRsaPrivateKey(this.clientRSAPriKey, encryptedMessageAesKey)
    ...
    async encryptPlainText () {
      ...
      if (pass) {
        ...
        if (this.groupMode) {
          ...
          if (this.CONST_DEBUG) {
            console.log('使用Server RSA公钥加密通讯密码的结果 :: serverPubKeyCryptedMessageAesKey => ', serverPubKeyCryptedMessageAesKey)
